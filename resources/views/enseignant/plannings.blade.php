...
@section('contents')
    <ul>
        ...
        <li><a href="{{ route('week') }}">Voir par la semaine </a></li>
        <li style="float:right"> <a href="{{ route('logout') }}">Déconnection</a>
        </li>
    </ul>
    <h1> Vos Plannings</h1>
    <form class="form-wrapper cf" action="{{ route('enseignant.plannings') }}" method="GET" role="search">
        ...
        <a class="bouncy" style="background-color:#DC143C;margin-left: 120px;margin-top: 5px"
            href="{{ route('enseignant.plannings') }}">
